...
export const JobLists = () => {
  ...
  const locationSearchHandler = () => {
    const filteredData = jobs.filter(job => job.location.toLowerCase().includes(searchLocation.toLocaleLowerCase()))
    setJobData(filteredData)
  }
  
  const filterJobData = (e:any) => {
        ...
        <div className="job__list__wrapper">
          <div className="search__panel">
            ...
            <div className="search__panel-02">
              ...
              <input type="text" value={searchLocation} onChange={e => setSearchLocation(e.target.value)} placeholder="Search by location" />
